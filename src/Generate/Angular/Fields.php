 ...
 */
class Fields extends \Mobileia\Expressive\Installer\Generate\BaseFile
{
    /**
     * Path del archivo a tener de base
     * @var string
     */
    protected $filePath = './vendor/mobileia/mia-installer-expressive/data/angular/fields.txt';
    /**
     * Path de la carpeta donde se va a guardar
     * @var string
     */
    protected $savePath = './data/angular/fields/';
    /**
     * Nombre de la DB
     *
     * @var string
    ...
    public function run()
    {
        ...
        file_put_contents($this->savePath . $this->name . '.fields.ts', $this->file);
    }
}
