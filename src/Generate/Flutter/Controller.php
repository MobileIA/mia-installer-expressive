 ...
 */
class Controller extends \Mobileia\Expressive\Installer\Generate\BaseFile
{
    /**
     * Path del archivo a tener de base
     * @var string
     */
    protected $filePath = './vendor/mobileia/mia-installer-expressive/data/flutter/controller.txt';
    /**
    ...
    public function run()
    {
        ...
        file_put_contents($this->savePath . $this->name  . '/' . $this->name . '.controller.dart', $this->file);
    }
}
